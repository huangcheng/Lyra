...
ALTER TABLE lyra_user ADD COLUMN IF NOT EXISTS singleton INTEGER NOT NULL DEFAULT 1 CHECK (singleton = 1);
CREATE UNIQUE INDEX IF NOT EXISTS lyra_user_singleton ON lyra_user(singleton);
